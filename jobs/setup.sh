...
# for testing
# "mxmller/rustybalancer-playground:latest"
# 5000
...
DEFAULT_LOW_LOAD_THRESHOLD="80.0"
DEFAULT_CRITICAL_LOAD_THRESHOLD="20.0"
...
echo "1) Plug-and-Play (Recommended)"
echo "2) Advanced Setup (Developers)"
